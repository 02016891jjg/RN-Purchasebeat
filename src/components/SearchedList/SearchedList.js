...
import styles from './SearchedList.styles';
...
class SearchedList extends Component {
    ...
    render() {
        const menu = <Menu page="SearchedList" soundLoadSuccess={this.state.soundLoadSuccess} onHideMenu={this.onHideMenu} />;
        const items = [];
                    ...
                    <View style={styles.headerBox}>
                        ...
                        <View style={styles.titleBox}>
                            <View style={styles.titleArea}>
                                ...
                                <Text style={styles.headerText}>Play List</Text>
                            </View>
                        </View>
                    </View>
...
export default withNavigation(SearchedList);
